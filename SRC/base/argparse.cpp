...
const char* argp_program_version = "kpartition 0.1.0";
const char* argp_program_bug_address = "k.murray@eecg.utoronto.ca";

//Program documentation
static char doc[] = "kpartition -- An Simple Brand and Bound Netlist Partitioner for ECE1387 2012 Assignment #3";
...
static struct argp_option options[] = {
    ...
    {"interactive_graphics", 'i', 0, 0, "Turn on interactive graphics"},
    {0}
};
